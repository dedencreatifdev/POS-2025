...
<body class="text-sm hold-transition sidebar-collapse layout-top-nav layout-navbar-fixed">
    <div class="wrapper">

        <!-- Navbar -->
        <nav class="border-white main-header navbar navbar-expand-md navbar-dark navbar-lightblue">
            <div class="container">
                <a wire:navigate href="{{ route('dashboard.store.index') }}" class="navbar-brand">
                ...
                <div class="order-3 collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a wire:navigate href="{{ route('dashboard.store.index') }}" class="nav-link">Home</a>
                        </li>
                        <li class="nav-item">
                                    ...
                                    <ul aria-labelledby="dropdownSubMenu2" class="border-0 shadow dropdown-menu">
                                        ...
                                        <li class="dropdown-submenu">
                                            ...
                                            <ul aria-labelledby="dropdownSubMenu3"
                                                class="border-0 shadow dropdown-menu">
                    ...
                    <!-- SEARCH FORM -->
                    <form class="ml-0 form-inline ml-md-3">
                            ...
                            <a href="#" class="dropdown-item">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="text-sm text-muted"><i class="mr-1 far fa-clock"></i> 4 Hours Ago
                                        </p>
                                    </div>
                                </div>
                                <!-- Message End -->
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a wire:navigate href="{{ route('dashboard.store.index') }}" class="brand-link">
                <img src="{{ asset('style/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo"
                    class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">{{ config('app.name') }}</span>
            </a>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ asset('style') }}/starter.html" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Starter Page</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ asset('style') }}/iframe.html" class="nav-link">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container">
                    <div class="mb-2 row">
                        <div class="col-sm-6">
                            <h1 class="m-0"><small>{{ $title ?? config('app.name') }}</small></h1>
                        </div>
                        <div class="col-sm-6">
